...
Related app areas: Team Settings, Dashboard, Farms, Finance, Investors, Approvals, Investor Portal
...
The BRS includes additional user groups such as farm manager, operations/log keeper, finance/admin, agronomist/advisor, buyer/customer, and platform administrator. Through Phase 5, these map onto the current team roles above rather than separate app roles.
...
- Confirm the page is implemented through Phase 5.
...
- Confirm the workflow is implemented through Phase 5.
- Confirm validation is not rejecting a cross-team reference.

## Current Limits

This guide does not define separate permissions for platform administrator, agronomist/advisor, buyer/customer, harvest, sales, capital recovery, AI, reports, exports, or backups because those workflows are not current through Phase 5.
